...
if(typeof Flags.ShowLines === 'undefined' )
  Flags.ShowLines = false;
if(typeof Flags.ShowHeaders === 'undefined' )
  Flags.ShowHeaders = false;
if(typeof Flags.ShowData === 'undefined' )
  Flags.ShowData = false;
if(typeof Flags.ShowLines === 'undefined' )
  Flags.ShowLines = false;
if(typeof Flags.ShowBackground === 'undefined' )
  Flags.ShowBackground = true;
if(typeof Flags.ShowCoords === 'undefined' )
  Flags.ShowCoords = false;
if(typeof Flags.FreezeCoordinates === 'undefined' )
  Flags.FreezeCoordinates = true;
if(typeof Flags.ShowTextBackground === 'undefined' )
  Flags.ShowTextBackground = false;
if(typeof Flags.ShowIndexes === 'undefined' )
  Flags.ShowIndexes = false;
if(typeof Flags.ShowStaticImages === 'undefined' )
  Flags.ShowStaticImages = true;
if(typeof Flags.ShowStaticText === 'undefined' )
  Flags.ShowStaticText = true;
if(typeof Flags.ResetAfterFailedTest === 'undefined' )
  Flags.ResetAfterFailedTest = false;
if(typeof Flags.ShowFailMessages === 'undefined' )
  Flags.ShowFailMessages = true;  
if(typeof Flags.ShowPoweredBy === 'undefined' )
  Flags.ShowPoweredBy = true;
if(typeof Flags.ShowDices === 'undefined' )
  Flags.ShowDices = true;
if(typeof Flags.UseGameEngine === 'undefined' )
  Flags.UseGameEngine = true;
if(typeof Flags.UsePixelCoordinates === 'undefined' )
  Flags.UsePixelCoordinates = true;
if(typeof Flags.ForceFramerate === 'undefined' )
  Flags.ForceFramerate = true;
