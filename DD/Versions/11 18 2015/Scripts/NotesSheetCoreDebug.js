...
function Init() {
    try {
        ...
        if (Flags.ShowBackground && BackgroundImageURI != undefined) {
            m.css('background', "url('" + BackgroundImageURI + "')");
            //Background = new Image();
            //Background.src = BackgroundImageURI;
            //Background.onload = function () { Paint(); };
        }
        MakeSelectors();
        MakeTests();
